            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.6s">
                        <div class="service-content">
                            <h3><a href="service-single.html">hunger relief</a></h3>
                            <p>Addressing hunger and malnutrition by providing nutritious meals</p>
                        </div>
                        <div class="service-image">
                            <figure class="image-anime">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.8s">
                        <div class="service-content">
                            <h3><a href="service-single.html">women empowerment</a></h3>
                            <p>Addressing hunger and malnutrition by providing nutritious meals</p>
                        </div>
                        <div class="service-image">
                            <figure class="image-anime">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="1s">
                        <div class="service-content">
                            <h3><a href="service-single.html">Youth leadership programs</a></h3>
                            <p>Addressing hunger and malnutrition by providing nutritious meals</p>
                        </div>
                        <div class="service-image">
                            <figure class="image-anime">
